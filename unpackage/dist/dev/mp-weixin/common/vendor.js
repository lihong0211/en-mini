...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "dialogue",
      "app-plus": {
        bounce: "vertical",
        titleNView: {
          buttons: [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "conversation",
      "app-plus": {
        bounce: "vertical",
        titleNView: {
          buttons: [
...
const globalStyle = {
  ...
  navigationBarTitleText: "Hello en",
  ...
  list: [
    {
      ...
      iconPath: "static/word.png",
      selectedIconPath: "static/word-hl.png",
      text: "words"
    },
    {
      pagePath: "pages/dialogue/dialogue",
      iconPath: "static/dialogue.png",
      selectedIconPath: "static/dialogue-hl.png",
      text: "dialogue"
    },
    {
      pagePath: "pages/conversation/conversation",
      iconPath: "static/conversation.png",
      selectedIconPath: "static/conversation-hl.png",
      text: "conversation"
    },
    {
      pagePath: "pages/test/test",
      iconPath: "static/test.png",
      selectedIconPath: "static/test-hl.png",
      text: "test"
    }
  ]
};
...
const appid = "__UNI__HelloUniApp";
...
let titleJsons = {};
titleJsons = { "pages/words/words": "words", "pages/dialogue/dialogue": "dialogue", "pages/conversation/conversation": "conversation", "pages/test/test": "test" };
...
const requestData = (done) => {
  const appid2 = "__UNI__HelloUniApp";
  let formData = {
    usv: STAT_VERSION,
    conf: JSON.stringify({
      ak: appid2
