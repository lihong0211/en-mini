  ...
  return common_vendor.e({
    a: common_vendor.f($data.list, (item, k0, i0) => {
      return common_vendor.e({
        ...
        b: common_vendor.o(($event) => $options.playAudio(item.word), item.url),
        c: common_vendor.t(item.meaning),
        d: item.type
      }, item.type ? {
        e: common_vendor.t(item.type.join("、"))
      } : {}, {
        f: item.collocation
      }, item.collocation ? {
        g: common_vendor.t(item.collocation)
      } : {}, {
        h: item.collocation
      }, item.collocation ? {
        i: common_vendor.t(item.collocation_meaning)
      } : {}, {
        j: item.mastered === 1,
        k: item.url,
        l: "4d4080e4-0-" + i0
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/lihong/Desktop/en/hello-uniapp/pages/words/words.vue"]]);
